      ...
      <header className="sticky top-0 z-50 border-b border-black/5 bg-white/90 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5">
          ...
          <div className="hidden items-center gap-6 text-sm font-bold text-slate-700 lg:flex">
            ...
            <a href="#consejo" className="hover:text-[#3871B7]">El Consejo</a>
            <a href="#comisiones" className="hover:text-[#3871B7]">Comisiones</a>
            <a href="#territorio" className="hover:text-[#3871B7]">Localidades</a>
            <a href="#transparencia" className="hover:text-[#3871B7]">Transparencia</a>
